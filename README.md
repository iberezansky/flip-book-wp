<h1>3D FlipBook WordPress plugin</h1>
...
This is github mirror of <a href="https://wordpress.org/plugins/interactive-3d-flipbook-powered-physics-engine/">the main repo</a>. You can clone this repo and build the plugin distributive from its files or download a ready distributive <a href="https://wordpress.org/plugins/interactive-3d-flipbook-powered-physics-engine/">here</a>. Detailed user manual is available <a href="http://3dflipbook.iberezansky.net/files/wp-3d-flip-book-user-manual.zip">here</a>.
