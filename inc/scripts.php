<?php
  ...
  function localize_scripts() {
    ...
    wp_localize_script(POST_ID.'-edit', 'FB3D_ADMIN_LOCALE', [
      'editMountNode'=> POST_ID.'-edit',
      'images'=> ASSETS_IMAGES,
      'dictionary'=> $fb3d['dictionary']
    ]);

    wp_localize_script(POST_ID.'-insert', 'FB3D_ADMIN_LOCALE', [
      'key'=> POST_ID,
      'templates'=> $fb3d['templates'],
      'dictionary'=> $fb3d['dictionary']
    ]);

    wp_localize_script(POST_ID.'-settings', 'FB3D_ADMIN_LOCALE', [
